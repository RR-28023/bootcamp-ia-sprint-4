...
from retrieval.indexing_pipeline_utils import get_synopsys_txt_5
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_synopsys_txt_5

        # Parámetros para la generación de embeddings

        self.model_name: str = "paraphrase-multilingual-mpnet-base-v2"   # "all-MiniLM-L6-v2"
