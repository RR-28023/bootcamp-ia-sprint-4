...
from retrieval.indexing_pipeline_utils import get_synopsys_txt , add_gen
from retrieval.retrieval_pipeline_utils import modificar_query
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = add_gen
        ...
        self._query_prepro_fn: Callable = modificar_query
