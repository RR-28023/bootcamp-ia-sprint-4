...
from retrieval.indexing_pipeline_utils import get_clean_synopsys_2
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_clean_synopsys_2

        # Parámetros para la generación de embeddings

        self.model_name: str = "jaimevera1107/all-MiniLM-L6-v2-similarity-es" #"all-MiniLM-L6-v2"
