...
from retrieval.indexing_pipeline_utils import get_enriched_movie_text
...
from retrieval.retrieval_pipeline_utils import clean_query_txt_new
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_enriched_movie_text

        # Parámetros para la generación de embeddings

        self.model_name: str = "distilroberta-base-paraphrase-v1"
        self.normalize_embeddings: bool = False  # Normalizar los embeddings a longitud 1 antes de indexarlos

        self._query_prepro_fn: Callable = clean_query_txt_new
