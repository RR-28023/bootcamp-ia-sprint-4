...
from retrieval.indexing_pipeline_utils import get_synopsys_txt, get_synopsys_and_genre_txt
from retrieval.retrieval_pipeline_utils import clean_query_txt, clean_query_stopwords_txt
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_synopsys_and_genre_txt
        ...
        self._query_prepro_fn: Callable = clean_query_stopwords_txt
