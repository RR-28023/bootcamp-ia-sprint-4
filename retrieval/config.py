...
from retrieval.indexing_pipeline_utils import get_synopsys_txt, get_movie_txt
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_movie_txt

        # Parámetros para la generación de embeddings

        self.model_name: str = "paraphrase-multilingual-MiniLM-L12-v2" # "all-MiniLM-L6-v2"
