...
from retrieval.indexing_pipeline_utils import (
    get_synopsys_txt,
    get_genre_director_and_synopsis,
    get_synopsis_and_genres,
    get_full_metadata,
)
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_genre_director_and_synopsis
        # Parámetros para la generación de embeddings

        self.model_name: str = "distiluse-base-multilingual-cased-v2"


        self.normalize_embeddings: bool = False  # Normalizar los embeddings a longitud 1 antes de indexarlos // CAMBIADO POR TRUE
