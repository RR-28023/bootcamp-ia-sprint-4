...
from retrieval.indexing_pipeline_utils import get_info_txt, get_more_info_txt, get_more_more_info_txt
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_more_more_info_txt

        # Parámetros para la generación de embeddings

        self.model_name: str = "BAAI/bge-small-en" #jinaai/jina-embeddings-v2-base-es"#"all-MiniLM-L6-v2"
