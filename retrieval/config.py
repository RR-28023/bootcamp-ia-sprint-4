...
from retrieval.indexing_pipeline_utils import get_clean_synopsis_and_genre_txt
from retrieval.retrieval_pipeline_utils import clean_query_txt, new_clean_query_txt
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_clean_synopsis_and_genre_txt
        ...
        self._query_prepro_fn: Callable = new_clean_query_txt
