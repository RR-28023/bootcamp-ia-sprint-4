...
from retrieval.indexing_pipeline_utils import get_detailed_description
from retrieval.retrieval_pipeline_utils import enhanced_clean_query_txt
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_detailed_description

        # Parámetros para la generación de embeddings

        self.model_name: str = "paraphrase-multilingual-MiniLM-L12-v2" #buscando he encontrado un mejor modelo de minilm que es multilingue
        self.normalize_embeddings: bool = False  # Normalizar los embeddings a longitud 1 antes de indexarlos

        self._query_prepro_fn: Callable = enhanced_clean_query_txt
